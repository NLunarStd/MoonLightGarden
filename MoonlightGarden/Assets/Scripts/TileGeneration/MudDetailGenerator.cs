...
public class MudDetailGenerator : TileGenerator
{
    public TileBase mudRuleTile;
    ...
    {
        if (underlineTile == mudTile)
        {
            targetTilemap.SetTile(new Vector3Int(detailX, detailY, 0), mudRuleTile);
            targetTilemap.SetTile(new Vector3Int(detailX + 1, detailY, 0), mudRuleTile);
            targetTilemap.SetTile(new Vector3Int(detailX, detailY + 1, 0), mudRuleTile);
            targetTilemap.SetTile(new Vector3Int(detailX + 1, detailY + 1, 0), mudRuleTile);
        }
    }
}
