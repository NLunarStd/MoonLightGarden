...
public class WaterDetailGenerator : TileGenerator
{
    ...
    {
        if (underlineTile == waterTile)
        {
            targetTilemap.SetTile(new Vector3Int(detailX, detailY, 0), waterRuleTile);
            targetTilemap.SetTile(new Vector3Int(detailX + 1, detailY, 0), waterRuleTile);
            targetTilemap.SetTile(new Vector3Int(detailX, detailY + 1, 0), waterRuleTile);
            targetTilemap.SetTile(new Vector3Int(detailX + 1, detailY + 1, 0), waterRuleTile);
        }
    }
}
